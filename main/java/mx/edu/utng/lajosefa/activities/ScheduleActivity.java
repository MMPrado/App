...
public class ScheduleActivity extends AppCompatActivity {
    ...
    private void sendMessage(){
        //send request
        Notification notification = new Notification(getString(R.string.bar_la_josefa),getString(R.string.schedule_modified));
                ...
                .enqueue(new Callback<MyResponse>() {
                    ...
                    public void onResponse(Call<MyResponse> call, Response<MyResponse> response) {
                        ...
                        if(response.isSuccessful()){
                            Toast.makeText(ScheduleActivity.this, (getString(R.string.success)), Toast.LENGTH_LONG).show();
                        }else{
                            Toast.makeText(ScheduleActivity.this, (getString(R.string.failed)) , Toast.LENGTH_SHORT).show();
                        }
                    }
