...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        botonCompartir = (Button) findViewById(R.id.button_share);
        ...
        mButtonUpload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(mUploadTask != null && mUploadTask.isInProgress() ){
                    Toast.makeText(mx.edu.utng.mmacias.uploadimage4.MainActivity.this, R.string.upload_progress,Toast.LENGTH_SHORT).show();
    ...
    private void openFileChooser() {
        final CharSequence[] option = {getString(R.string.take_photo), getString(R.string.choose_gallery), getString(R.string.exit)};
        final AlertDialog.Builder builder = new AlertDialog.Builder(mx.edu.utng.mmacias.uploadimage4.MainActivity.this);
            ...
            mUploadTask = fileReference.putFile(mImageUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Toast.makeText(mx.edu.utng.mmacias.uploadimage4.MainActivity.this, R.string.upload_sucess, Toast.LENGTH_SHORT).show();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(mx.edu.utng.mmacias.uploadimage4.MainActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    })
