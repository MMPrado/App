...
public class ChatActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    private static final int photoSend = 1;
    private FirebaseStorage storage;
    private StorageReference storageReference;
    private static final int photoProfile= 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imbSend = findViewById(R.id.btn_send);
        ...
        imbSendPicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                startActivityForResult(Intent.createChooser(i,getString(R.string.select_photo)),photoSend);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == photoSend && resultCode == RESULT_OK){
            Uri u = data.getData();
            storageReference = storage.getReference("media_chat");
            ...
            photoReference.putFile(u).addOnSuccessListener(this, new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    SendMessage m = new SendMessage(username+getString(R.string.photo_send),
                            u.toString(),username,profilePhoto,
                            "2",ServerValue.TIMESTAMP);
                    reference.push().setValue(m);
                }
            });
        }else if(requestCode == photoProfile && resultCode == RESULT_OK){
          /* Uri u = data.getData();
        ...
        Auth.GoogleSignInApi.signOut(googleApiClient).setResultCallback(new ResultCallback<Status>() {
            ...
            public void onResult(@NonNull Status status) {
                if(status.isSuccess()){
                    ...
                    Toast.makeText(getApplicationContext(), R.string.Unable_to_close_session, Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
