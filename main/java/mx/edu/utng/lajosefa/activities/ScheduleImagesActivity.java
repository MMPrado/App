...
public class ScheduleImagesActivity extends AppCompatActivity implements ScheduleImageAdapter.OnItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rcvRecyclerView = findViewById(R.id.rcv_schedule);
        rcvRecyclerView.setHasFixedSize(true);
        rcvRecyclerView.setLayoutManager(new LinearLayoutManager(this));
        ...
        rcvRecyclerView.setAdapter(scheduleImageAdapter);
